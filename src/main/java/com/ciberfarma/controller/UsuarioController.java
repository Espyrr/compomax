...
public class UsuarioController {
	...
	@GetMapping("/login")
	public String mostrarFormularioLogin(HttpSession session, Model model, @ModelAttribute("mensaje") String mensaje) {
	...
	@PostMapping("/login")
	public String procesarLogin(@RequestParam("correo") String correo, @RequestParam("clave") String clave,
	...
	public String procesarRegistro(@Valid @ModelAttribute("usuario") Usuario usuario, BindingResult result, Model model,
	...
	public String eliminarUsuario(@PathVariable("id") Integer id, RedirectAttributes redirect, HttpSession session) {
		Usuario u = (Usuario) session.getAttribute("usuarioLogueado");
		if (u == null || u.getIdTipo().getIdTipo() != 1) {
			return "redirect:/acceso-denegado";
		}
